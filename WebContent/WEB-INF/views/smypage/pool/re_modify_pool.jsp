...
%>
	<div class="cusSec_right">
		...
		<div class ="company_regi"  style = "margin-top : 10px;">
			...
			<input name = "pool_name" id = "pool_name" type="text" value="${pool.pool_name }"  size = "500">
		</div>
		<div class ="company_regi" style = "margin-top : 10px;">
			<label style = "width:100px;">대표자명</label>
			<input type="text" name = "pool_owner" id = "pool_owner" value="${pool.pool_owner }"  size = "150">
		</div>
		<div class ="company_regi"  style = "margin-top : 10px;">
			<label style = "width:100px;">사업자등록번호</label>
			<input type="text" id = "pool_number" name = "pool_number" value= "${pool.pool_number }" size = "150">
		</div>
		<div class ="company_regi"  style = "margin-top : 10px;">
			<label style = "width:100px;">수영장 주소</label>
			<input type="text" value ="<%=address[0] %>" onclick="sample6_execDaumPostcode()" id="sample6_postcode" placeholder="우편번호" readonly >
