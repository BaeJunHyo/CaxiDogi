...
%>
	<div class="cusSec_right">
		...
		<div class ="company_regi" style = "margin-top : 10px;">
			...
			<input type="text" value="${shop.shop_owner }" id = "shop_owner" name = "shop_owner"  size = "150">
		</div>
		<div class ="company_regi"  style = "margin-top : 10px;">
			<label style = "width:100px;">사업자등록번호</label>
			<input type="text" value = "${shop.shop_number }" id = "shop_number" name = "shop_number" size = "150">
		</div>
		<div class ="company_regi"  style = "margin-top : 10px;">
