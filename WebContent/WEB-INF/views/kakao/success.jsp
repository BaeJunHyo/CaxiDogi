...
p{color: #7d7d7d;}
.btn_1{display: inline-block; height: 50px; padding: 0 35px; text-align: center; font-size: 18px; line-height: 50px; font-weight: bold; color: #000; background: #ffeb00;text-decoration:none;}
</style>
...
<script type="text/javascript">
	$("#closeBtn").click(function () {
		opener.parent.paymentConfirm(1);
		close();
	});
